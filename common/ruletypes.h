...
RULE_BOOL(Combat, AllowGroupMembersPVP, false) // true enables group members to hurt each other in PvP. 
RULE_BOOL(Combat, AllowGuildMembersPVP, false) // true enables Guild members to hurt each other in PvP. 
RULE_CATEGORY_END()
